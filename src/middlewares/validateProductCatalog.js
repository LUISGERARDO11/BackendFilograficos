...
const validateGetProductById = [positiveInt('product_id').withMessage('El ID del producto debe ser un número entero positivo').toInt()];
...
const validateGetAllVariants = [
    ...
    query('product_type').optional().isIn(['Existencia', 'Personalizado']).withMessage('El tipo de producto debe ser "Existencia" o "Personalizado"'),
    positiveInt('page').optional().withMessage('La página debe ser un entero positivo'),
    positiveInt('limit').optional().withMessage('El límite debe ser un entero positivo'),
...
const validateGetVariantById = [positiveInt('id').withMessage('El ID de la variante debe ser un entero positivo').toInt()];

const validateUpdateVariantPrice = [
    positiveInt('id').withMessage('El ID de la variante debe ser un entero positivo').toInt(),
    positiveFloat('production_cost').withMessage('El costo de producción debe ser un número positivo'),
    positiveFloat('profit_margin').withMessage('El margen de ganancia debe ser un número positivo'),
];

const validateGetPriceHistory = [positiveInt('variant_id').withMessage('El ID de la variante debe ser un entero positivo').toInt()];

const validateBatchUpdateVariantPrices = [
    requiredArray('variant_ids').withMessage('Debe proporcionar al menos un ID de variante')
...
const validateBatchUpdateVariantPricesIndividual = [
    requiredArray('variants').withMessage('Debe proporcionar al menos una variante para actualizar'),
    positiveInt('variants.*.variant_id').withMessage('El ID de la variante debe ser un entero positivo'),
